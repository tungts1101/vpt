...
from src.engine.trainer_barlow_twin import BarlowTwinTrainer
...
def train(cfg, args):
    ...
    trainer = BarlowTwinTrainer(cfg, model, evaluator, cur_device)
    trainer.feed_one_batch(next(iter(train_loader)))

    # if train_loader:
    #     trainer.train_segmentation(train_loader, val_loader, test_loader)
    # else:
